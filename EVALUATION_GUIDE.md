...
| 3 | Downstream | High-target acceptance | 5 kW DR event, HEMS evaluates and commits via PV pre-charging |
...
| Downstream | High-target acceptance | 3.4 +/- 0.5 | 2.4 +/- 0.5 | ~22k | 7.8 +/- 2.2 |
